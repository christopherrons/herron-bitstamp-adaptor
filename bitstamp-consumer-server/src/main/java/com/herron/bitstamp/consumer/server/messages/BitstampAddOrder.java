...
import static com.herron.exchange.common.api.common.enums.MessageTypesEnum.BITSTAMP_ADD_ORDER;
    ...
    /*  Json Structure example of Bitstamp Live Order
{
    ...
    public BitstampAddOrder(AddOrder order) {
